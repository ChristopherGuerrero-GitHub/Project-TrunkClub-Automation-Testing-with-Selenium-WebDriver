...
import common.tests.DriverSetupFF;
...
public class HeaderMenuOptions {
	...
	public void temp () {
        ...
        WebElement wElemLnk = objFAQ.getHomePage();
        wElemLnk.click();
        testDriverFF.navigate().back();
        objFAQ.refreshElements();
        
        wElemLnk = objFAQ.getWomenPage();
        wElemLnk.click();
        //testDriverFF.navigate().back();
        ...
        wElemLnk = objFAQ.getSignInPage();
        wElemLnk.click();
        testDriverFF.navigate().back();
        objFAQ.refreshElements();
        
        wElemLnk = objFAQ.getGetStartedPage();
        wElemLnk.click();
        testDriverFF.navigate().back();
        objFAQ.refreshElements();
