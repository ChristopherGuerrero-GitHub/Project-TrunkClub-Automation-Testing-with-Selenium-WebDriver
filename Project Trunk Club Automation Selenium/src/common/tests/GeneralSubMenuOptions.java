...
public class GeneralSubMenuOptions {
	...
	public void temp3() {
        ...
        List <WebElement> tmpHGX= objFAQ.getHeaderGeneralX();
        
        for(int i = 0; i < tmpHGX.size(); i++){
        	tmpHGX.get(i).click();
        }
		
        List <WebElement> tmpHGL = objFAQ.getHeaderGeneralLinkX();
        ...
        tmpHGL = objFAQ.resetHeaderGeneralLinkX();
